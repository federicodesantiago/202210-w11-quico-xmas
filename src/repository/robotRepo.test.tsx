...
describe('Given a Task Repo', () => {
    const mockData = [
        new RobotClass('Cortocircuito', 5, 7, 'Pepe'),
        new RobotClass('Robocop', 9, 9, 'Police'),
    ];
    ...
    test('Then we can instantiate it', () => {
        expect(repo).toBeInstanceOf(RobotRepo);
    });
    ...
    describe('When we use create method', () => {
        test(`Then if the data are VALID, we received the task 
            ...
            expect(data).toHaveProperty('speed', mockNewTaskPayload.speed);
            expect(data).toHaveProperty('stamina', mockNewTaskPayload.stamina);
